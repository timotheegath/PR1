...
Figure \ref{fig:} shows the results of the experiment where the number of retained fisher-faces ($M_{lda}$) is gradually decreased, and the dimension of the PCA subspace is kept as N-c. We can see that the accuracy worsens as the $M_{lda}$ decreases.
